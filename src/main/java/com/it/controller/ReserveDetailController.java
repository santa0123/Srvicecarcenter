...
public class ReserveDetailController {
	...
	@PutMapping("/{resde_id}")
	public ResponseEntity<Object> updateReservde(@PathVariable(name = "resde_id") Integer resdeId, @RequestBody ReserveDetailDto reservedetailDto) {
		return ResponseEntity.ok(reservedeService.updateReservedeId(resdeId, reservedetailDto));		
	}
